                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Create Customer Account</h3>
                                </div>
                                <div class="card-body">
...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `customer` (`name` , `Last_name` , `address` , `username` , `password`,`profileIMG`) values('$firstn' , '$lastn' , '$add' , '$email' , '$password','$target')";

...
<footer class="bg-dark text-center text-lg-start text-light">
    ...
    <div class="container p-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
                <h5 class="text-uppercase">ArtGallary</h5>

                <p>
                    Bringing artists and art lovers togather ,we hope to provide a place where people can showcase there masterpieces,
                    And for the art lovers who like to collect these masterpieces .Our goal is to bring every artist to reach out to the world.
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
        © 2020 Copyright: artgallery.com
        <!-- <a class="text-light" href="https://artgallery.com/">MDBootstrap.com</a> -->
    </div>
    <!-- Copyright -->
</footer>
<!-- Footer -->

...
<section class="my-5px">
  ...
  <div class="container-fluid shadow-lg border-0">
          <div class="row">
  <?php
  ...
  ?>
    <div class="col-lg-4  col-md-4 col-12 pb-4 position-static  rounded-lg ">
             ...
             <a href="<?php echo$url[$i]?>" class=" "></a>
              <img src="<?php echo $url[$i]?>" alt="image" class="img-responsive pb-3 " width="100%" height="300vp">
              </a>
              <!-- </div> -->
             <div class="m-2 initialism"> <h4 class="card-title text-center" ><?php echo $name[$i].$lastname[$i]?></h4></div>
